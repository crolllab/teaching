...
```r
download.file(
  "https://raw.githubusercontent.com/crolllab/teaching/master/Ecological_Genomics/app_transloc.R",
  destfile = "app_transloc.R",
  method   = "wget"
)
```
...
```r
download.file(
  "https://raw.githubusercontent.com/crolllab/teaching/master/Ecological_Genomics/Tutorial_2_MutationLoad.qmd",
  destfile = "Tutorial_2_MutationLoad.qmd",
  method   = "wget"
)
```
...
3. Navigate to the tutorial:
   ...
   cd teaching/Ecological_Genomics
   ```
4. Open `Tutorial_2_MutationLoad.qmd` from the **Files** pane (bottom-right) or with:
   ```r
   file.edit("Tutorial_2_MutationLoad.qmd")
   ```
...
```r
download.file(
  "https://raw.githubusercontent.com/crolllab/teaching/master/Ecological_Genomics/app_load.R",
  destfile = "app_load.R",
  method   = "wget"
)
```
